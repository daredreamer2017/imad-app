...
app.get('/article-one', function (req, res) {
  res.send("Articele one requested and shown here");
});
...
height="200"/>
    <img src="https://media.dailyfx.com/illustrations/2016/07/29/AUDUSD-Hanging-JWew_body_Picture_1.png"width="200"
height="200"/>
...
<a href="http://www.moneycontrol.com/annual-report/steelauthorityindia/directors-report/SAI">For More details</a>
<div class="lastsec">
  <button class="btn-default btn-danger">Click</button>
  <p style="color:red";>Show your Support</p>
</div>
);
});

app.get('/article-three', function (req, res) {
  res.send("Articele three requested and shown here");
});
